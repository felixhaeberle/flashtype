...
import type { PanelState, WidgetContext, WidgetInstance } from "./types";
...
export function useWidgetContext({
	...
	makeContext: (instance: WidgetInstance) => WidgetContext;
} {
	const baseContext = useMemo<WidgetContext>(() => {
	...
	>({});
	const contextRef = useRef<Record<string, WidgetContext>>({});
	...
	const makeContext = useCallback(
		(instance: WidgetInstance): WidgetContext => {
